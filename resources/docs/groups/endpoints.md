...
```bash
curl -X DELETE \
    "http://localhost/oauth/tokens/expedita" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X PUT \
    "http://localhost/oauth/clients/voluptates" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X DELETE \
    "http://localhost/oauth/clients/perspiciatis" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X DELETE \
    "http://localhost/oauth/personal-access-tokens/vitae" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
