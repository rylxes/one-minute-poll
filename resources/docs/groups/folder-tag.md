...
curl -X POST \
    ...
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -d '{"folder_id":14,"tag_id":1,"created_at":{},"updated_at":{}}'
...
```bash
curl -X GET \
    -G "http://localhost/api/folder_tags/culpa" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://localhost/api/folder_tags/culpa"
);
...
```bash
curl -X PUT \
    "http://localhost/api/folder_tags/non" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -d '{"folder_id":17,"tag_id":12,"created_at":{},"updated_at":{}}'
...
```bash
curl -X DELETE \
    "http://localhost/api/folder_tags/id" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
