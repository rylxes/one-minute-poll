...
curl -X POST \
    ...
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -d '{"folder_id":17,"tag_id":11,"created_at":{},"updated_at":{}}'
...
```bash
curl -X GET \
    -G "http://localhost/api/folder_tags/maiores" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://localhost/api/folder_tags/maiores"
);
...
```bash
curl -X PUT \
    "http://localhost/api/folder_tags/ut" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -d '{"folder_id":8,"tag_id":4,"created_at":{},"updated_at":{}}'
...
```bash
curl -X DELETE \
    "http://localhost/api/folder_tags/enim" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
