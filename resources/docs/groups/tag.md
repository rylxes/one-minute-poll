...
curl -X POST \
    ...
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -d '{"name":"eos","colour":"magnam","company_id":17}'
...
```bash
curl -X GET \
    -G "http://localhost/api/tags/eaque" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
curl -X PUT \
    ...
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -d '{"name":"natus","colour":"eum","company_id":11}'
...
```bash
curl -X DELETE \
    "http://localhost/api/tags/eligendi" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
