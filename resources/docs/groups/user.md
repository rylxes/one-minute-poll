...
curl -X POST \
    ...
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -d '{"group_id":"autem","email":"corrupti"}'
...
```bash
curl -X GET \
    -G "http://localhost/api/users/dolores" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X DELETE \
    "http://localhost/api/users/fugiat" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
